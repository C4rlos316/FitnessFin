...
public class AdapterRutinasFeed extends RecyclerView.Adapter<AdapterRutinasFeed.FeedViewHolder>
        implements View.OnClickListener{

    AdapterRutinasFeed adapterRecetario;
    ...
    public AdapterRutinasFeed(ArrayList<Feed>feeds){

        this.feeds=feeds;
    }

    @Override
    public AdapterRutinasFeed.FeedViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        View v= LayoutInflater.from(parent.getContext()).inflate(R.layout.usuario_14_diseno,null,false);
        v.setOnClickListener(this);

        AdapterRutinasFeed.FeedViewHolder holder=new AdapterRutinasFeed.FeedViewHolder(v);
        return holder;
    }


    @Override
    public void onBindViewHolder(@NonNull AdapterRutinasFeed.FeedViewHolder holder, int position) {
        ...
        if (feed.getTipo_feed().equals(Contants.RUTINAS) && feed.is_gratis) {
