package com.appfitnessapp.app.fitnessapp.Admin.AgregarElementosFeed;
...
public class AgregarRutinas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Agregar Rutina");
        ...
        txtSeleccionar.setText("Seleccionar Rutina a subir");
        txtQueTipo.setText("La rutina de que tipo sera:");
        ...
        btnImg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ContextCompat.checkSelfPermission(AgregarRutinas.this, Manifest.permission.READ_EXTERNAL_STORAGE)== PackageManager.PERMISSION_GRANTED){
                    selectImage();
                }
                else {
                    ActivityCompat.requestPermissions(AgregarRutinas.this,new String[]{Manifest.permission.READ_EXTERNAL_STORAGE},9);
                }
        ...
        btnPdf.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ContextCompat.checkSelfPermission(AgregarRutinas.this, Manifest.permission.READ_EXTERNAL_STORAGE)== PackageManager.PERMISSION_GRANTED){
                    ...
                    ActivityCompat.requestPermissions(AgregarRutinas.this,new String[]{Manifest.permission.READ_EXTERNAL_STORAGE},10);
                }
            }
        });
            ...
            public void onClick(View v) {
                ...
                if (!descripcion.isEmpty()&&pdfUri!=null&&imgUri!=null){
                    ...
                    if (rdGratis.isChecked()){
                        ...
                        Toast.makeText(AgregarRutinas.this, "Selecciona el tipo de pdf a subir.", Toast.LENGTH_SHORT).show();
                    }
                    ...
                    Toast.makeText(AgregarRutinas.this, "Revisa que tengas todos los campos completos.", Toast.LENGTH_SHORT).show();
                }
        ...
        txtSiguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i  = new Intent(AgregarRutinas.this, AdminAgregarFeed.class);
    ...
    private void uploadPDF( final String descripcion, final String imgPrincipal, final String timestamp, final String costo,
        ...
        final StorageReference storageReference1 =  mStorage.child(Contants.TABLA_RUTINAS).child(fileName);
        ...
        storageReference1.putFile(pdfUri)
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        storageReference1.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onSuccess(Uri uri) {
                                ...
                                Toast.makeText(AgregarRutinas.this, "Se subió correctamente la información", Toast.LENGTH_SHORT).show();
                            }
                        });
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(AgregarRutinas.this, "Hubo un error al subir el vídeo.", Toast.LENGTH_SHORT).show();
            ...
            uploadTask2.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    storageReference1.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        @Override
                        public void onSuccess(Uri uri) {
                            dbProvider.subirFeed(Contants.RUTINAS,gratis,uri.toString(),costo,pdf,timestamp,
                                    descripcion,id);
                ...
                @Override
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(AgregarRutinas.this, "Hubo un error al subir la imágen.", Toast.LENGTH_SHORT).show();
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode==9 && grantResults[0]== PackageManager.PERMISSION_GRANTED){
            ...
            Toast.makeText(AgregarRutinas.this, "Permite el acceso a la galeria.", Toast.LENGTH_SHORT).show();
        }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode==86&& resultCode ==RESULT_OK && data!= null){
            ...
            Toast.makeText(AgregarRutinas.this,"Selecciona un archivo", Toast.LENGTH_SHORT).show();
        }
