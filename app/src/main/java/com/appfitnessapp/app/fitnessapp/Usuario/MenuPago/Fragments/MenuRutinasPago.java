...
public class MenuRutinasPago extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        feeds = new ArrayList<>();
        adapterFeed = new AdapterRutinasFeed(feeds);
        ...
        adapterFeed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (feeds.get(recyclerView.getChildAdapterPosition(view)).getTipo_feed().equals(Contants.RUTINAS)) {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists()) {
                    for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                        ...
                        if (feed.tipo_feed.equals(Contants.RUTINAS)) {
                            feeds.add(feed);
