...
import com.appfitnessapp.app.fitnessapp.Usuario.DetallesImagen;

import com.appfitnessapp.app.fitnessapp.Usuario.QuienAsesoria;
...
public class Menu_Asesorias_U extends Fragment {
    ...
    public void bajarComentarios(){
        dbProvider = new DBProvider();
        dbProvider.valoracionAsesoria().addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                plan.clear();
